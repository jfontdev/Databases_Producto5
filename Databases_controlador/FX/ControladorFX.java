...
public class ControladorFX implements Initializable {
    ...
    private void showArticles(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/Databases_vista/FX/ArticuloVistaFX.fxml"));
            Parent root = loader.load();

            ArticuloControladorFX controller = loader.getController();
            ...
            Stage myStage = (Stage) this.btnShowArticle.getScene().getWindow();
            myStage.close();
        } catch (Exception e) {
